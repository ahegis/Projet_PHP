	...
	<h1 style='font-variant:small-caps;text-align:center'>Choix de la Table à Editer</h1>"
		...
		<?php
			if(isset($_POST['table'])){
				$table=$_POST['table'];
				switch($table){
					case "TDF_COUREUR":	header("location:../Coureur/form_coureur_add.php");
										break;
					case "TDF_ANNEE" : 	header("location:../Annee/form_annee_add.php");
										break;
					case "TDF_EPREUVE" : header("location:../Epreuve/form_epreuve_add.php");
										break;
				}
			}
